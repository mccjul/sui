...
use types::{
    ...
    RequestVoteRequest, RequestVoteResponse, Round, Vote, VoteInfo, WorkerInfoResponse,
...
impl PrimaryReceiverHandler {
    ...
    async fn process_request_vote(
        ...
        let peer_id = request
            .peer_id()
            .ok_or_else(|| DagError::NetworkError(format!("Unable to access remote peer ID")))?;
